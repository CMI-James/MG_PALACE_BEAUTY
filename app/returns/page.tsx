        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <Card className="border-primary/10">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  in original condition, unused, and in original packaging.
                </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Beauty tools, unopened cosmetics, accessories
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                ...
                <div className="space-y-4">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Email returns@mgbeautypalace.com or call +234 (0) 123
                        456 7890 to initiate your return
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Securely package the item with all original materials
                        and ship using provided label
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Refund processed within 5-7 business days after we
                        receive your return
                      </p>
                    </div>
                  </div>
            ...
            <Card className="border-primary/10">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  We offer exchanges for defective items or wrong items sent.
                  For size or color exchanges, please return the original item
            ...
            <Card className="border-primary/10">
              ...
              <CardContent className="space-y-4">
                <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                  ...
                  <li>
                    Processing time: 5-7 business days after return received
                  </li>
                  <li>
