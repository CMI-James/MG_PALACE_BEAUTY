      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Everything you need to know about our delivery services</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <Card className="border-primary/10">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground">Quick and reliable shipping across Nigeria</p>
              </CardContent>
            </Card>
            <Card className="border-primary/10">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground">Your items are carefully packaged for safe delivery</p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="space-y-6">
            <Card className="border-primary/10">
              ...
              <CardContent className="space-y-4">
                <div>
                  <h4 className="font-semibold text-foreground mb-2">Lagos State</h4>
                  <p className="text-muted-foreground leading-relaxed">
                    Same-day delivery available for orders placed before 2 PM. Standard delivery: 1-2 business days.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Express delivery: 2-3 business days. Standard delivery: 3-5 business days.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-foreground mb-2">Other Locations</h4>
                  <p className="text-muted-foreground leading-relaxed">
                    Standard delivery: 5-7 business days. Remote areas may require additional time.
                  </p>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-4 bg-primary/5 rounded-lg">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Lagos only, orders before 2 PM</p>
                    </div>
                  ...
                  <div className="flex justify-between items-center p-4 bg-secondary/5 rounded-lg">
                    <div>
                      <h4 className="font-semibold text-foreground">Express Delivery</h4>
                      <p className="text-sm text-muted-foreground">2-3 business days</p>
                    </div>
                    <span className="font-bold text-secondary-foreground">₦1,500</span>
                  </div>
                  <div className="flex justify-between items-center p-4 bg-muted/50 rounded-lg">
                    <div>
                      <h4 className="font-semibold text-foreground">Standard Delivery</h4>
                  ...
                  <div className="flex justify-between items-center p-4 bg-primary/10 rounded-lg border border-primary/20">
                    <div>
                      <h4 className="font-semibold text-primary">Free Delivery</h4>
            ...
            <Card className="border-primary/10">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  Orders are processed Monday through Friday, 9 AM to 6 PM. Orders placed on weekends or holidays will
            ...
            <Card className="border-primary/10">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Large or specialized beauty equipment may require additional processing time and special handling.
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Custom or made-to-order items have extended processing times. Delivery timeframes will be
