        ...
        <div className="max-w-2xl mx-auto">
          ...
          {trackingData && (
            <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <p className="font-medium">
                        Order #{trackingData.order_id.slice(0, 8)}
                      </p>
                    ...
                    <Badge
                      className={getStatusColor(trackingData.shipping_status)}
                    >
                      {trackingData.shipping_status.charAt(0).toUpperCase() +
                        trackingData.shipping_status.slice(1)}
                    </Badge>
                  </div>
              ...
              {/* Shipping Updates */}
              {trackingData.shipping_updates &&
                trackingData.shipping_updates.length > 0 && (
                  <Card>
                    <CardHeader>
                      ...
                      <div className="space-y-4">
                        {trackingData.shipping_updates.map((update, index) => (
                          <div key={update.id}>
                            ...
                            {index <
                              trackingData.shipping_updates.length - 1 && (
