            ...
            <Card className="border-primary/10">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  About our services and policies
                </p>
              </CardContent>
            </Card>
            <Card className="border-primary/10">
              ...
              <CardContent>
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1">
                    <AccordionTrigger>
                      What services does MG Beauty Palace offer?
                    </AccordionTrigger>
                    <AccordionContent>
                      We offer professional beauty services including
                      microblading, lash extensions, brow shaping, and various
                      beauty treatments. We also sell professional beauty tools
                      and equipment.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-2">
                    ...
                    <AccordionContent>
                      ...
                      system, by calling us at +234 (0) 123 456 7890, or by
                      visiting our location. Online bookings are available 24/7
                      and require confirmation from our team.
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-4">
                    ...
                    <AccordionContent>
                      Yes, we offer professional training courses in
                      microblading, lash extensions, and other beauty
                      techniques. Contact us for course schedules and enrollment
                      information.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
              ...
              <CardContent>
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="service-1">
                    ...
                    <AccordionContent>
                      We recommend booking at least 1-2 weeks in advance,
                      especially for popular services like microblading.
                      However, we often have same-day availability for certain
                      services.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="service-2">
                    ...
                    <AccordionContent>
                      ...
                      with less than 24 hours notice or no-shows may be subject
              ...
              <CardContent>
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="product-1">
                    ...
                    <AccordionContent>
                      Yes, we ship to all states in Nigeria. Delivery times vary
                      by location: Lagos (1-2 days), major cities (2-3 days),
                      other locations (3-7 days).
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="product-2">
                    ...
                    <AccordionContent>
                      ...
                      cards, bank transfers, and mobile payments through our
                  ...
                  <AccordionItem value="product-3">
                    ...
                    <AccordionContent>
                      ...
                      original packaging. Some items like opened cosmetics
                      cannot be returned for health and safety reasons.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="product-4">
                    ...
                    <AccordionContent>
                      Yes, we offer discounts for bulk orders and professional
                      customers. Contact us directly for wholesale pricing and
                      volume discounts.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="tech-1">
                    ...
                    <AccordionContent>
                      ...
                      different browser. If problems persist, contact our
                      technical support team at support@mgbeautypalace.com.
                    </AccordionContent>
                  </AccordionItem>
